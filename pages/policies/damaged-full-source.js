...
export default function DamagedPolicyFullSource() {
  return (
    <main style={pageStyle}><div style={shell}>
      <Header type="ITEM RECEIVED" title="Damaged Policy" color="#dc2626" sourceHref="/docs/policies/damaged-myka-tg.docx" sourceLabel="Open original Word file" subtitle="Use for factory defects, inscription errors, tarnishing, breakage, tangled/broken chains, and other confirmed damage cases." />
      ...
      <Section title="Replacement Options" color="#2563eb"><h3>DIY Chain / Bracelet</h3><BulletList items={["Customer can replace the part themselves.", "Order only the damaged part.", "Link the order."]} /><h3 style={{ marginTop: 18 }}>Not DIY / Full Item Needed</h3><p style={p}>Includes broken non-detachable chains, pendants, earrings, rings, fallen stones.</p><BulletList items={["Create draft order in OCS.", "Escalate reorder in Kustomer with form and remarks.", "0–2 weeks after ETA: use same shipping method as original.", "2+ weeks after ETA: downgrade to Standard."]} /></Section>
